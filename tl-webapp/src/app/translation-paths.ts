...
export const TOOLBAR_PATH = `${APP_PATH}.toolbar`;
export const LOGIN_PATH = `${APP_PATH}.login`;
export const REGISTER_PATH = `${APP_PATH}.register`;
export const DETAILS_PATH = `${APP_PATH}.details`;
export const OVERVIEW_PATH = `${APP_PATH}.overview`
